...
import { getQueryClient } from '@/app/lib/react-query/getQueryClient';
import { projectsQueryOptions } from '@/app/components/features/projects/queries';
  ...
  return (
    <HydrationBoundary state={dehydrate(queryClient)}>
      <div className="flex flex-col gap-6 p-8">
        ...
        <div className="hidden lg:flex items-center justify-between border-t border-dashed border-slate-light pt-4">
